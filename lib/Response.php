<?php
class SimpleRestHttpResponse implements ArrayAccess, Countable, IteratorAggregate {
    protected $status;
    ...
    public function __construct( $body = '', $status = 200, $header = array() ) {
        ...
        $this->header = new SimpleRestHttpHeaders(array_merge(array('Content-Type' => 'text/html'), $headers));
        $this->body = '';
        $this->write($body);
    }
